...
class SportThemeConfig {
  ...
  static const palettes = <SportType, SportThemePalette>{
    SportType.padel: SportThemePalette(
      ...
      chipBackground: Color(0xFFFFF9C4),
      emoji: '🎾',
    ),
    ...
    SportType.tennis: SportThemePalette(
      ...
      cardBackground: Color(0xFFFBE9E7),
      surfaceTint: Color(0xFFFFCCBC),
    ...
    SportType.general: SportThemePalette(
      ...
      cardBackground: Color(0xFFECEFF1),
      surfaceTint: Color(0xFFB0BEC5),
      chipBackground: Color(0xFFE0F7FA),
      emoji: '🏆',
    ),
  };
